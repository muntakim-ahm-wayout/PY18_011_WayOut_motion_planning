...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        goal_position_global=[-122.401216,37.796713,0]
        ...
        mini_num_waypoints=prune_path(path)

        # Convert path to waypoints
        waypoints = [[p[0] + north_offset, p[1] + east_offset, TARGET_ALTITUDE, 0] for p in mini_num_waypoints]
        # Set self.waypoints
